# TimeTracker Pro Contributor License Agreement
...
TimeTracker Pro is MIT licensed and the self-hosted application will stay free
and open. But features that need a server the maintainer runs — a hosted
instance, syncing between machines, shared team workspaces — may one day be
offered under different terms to fund the work.
...
of the maintainer, **Sebastian Girz** ([@girzsebastian](https://github.com/girzsebastian)),
...
| Name in git | Email |
|---|---|
| `Sebastian Girz` | `girz.sebastiannicolae@gmail.com` |
...
or additions to existing work, that you intentionally submit to TimeTracker Pro.
...
**"Project"** means the TimeTracker Pro repository at
https://github.com/girzsebastian/timetracker-pro and its maintainer.
